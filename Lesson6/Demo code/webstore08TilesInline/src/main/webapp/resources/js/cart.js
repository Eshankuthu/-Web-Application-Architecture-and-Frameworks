$(document).ready(function() {
	...
	addToCart = function(productId){
			$.ajax({
		 		url: '/webstore08DeclarativeTiles/rest/cart/add/' + productId,
		 		type: 'PUT',
				dataType: "json",
	   ...
	   removeFromCart = function(productId) {
			$.ajax({
				url: '/webstore08DeclarativeTiles/rest/cart/remove/'+ productId,
		 		type: 'PUT',
				dataType: "json",
			 	 success: function (response) {
	 ...
	 // Click on Product [row]  in cart
	   ...
	   function showProduct(productId) {
			$.ajax({
				url: '/webstore08DeclarativeTiles/rest/cart/showProduct',
		 		type: 'GET',
		 		async:false,
				dataType: "json",
				data:'id=' + productId,
...
/*		 getCartId = function( ) {
				$.ajax({
					url: '/webstore08DeclarativeTiles/rest/cart/getId/',
					type: 'GET',
					success : function(id) {
					 		 		 cartId = id;
					 	 		}
