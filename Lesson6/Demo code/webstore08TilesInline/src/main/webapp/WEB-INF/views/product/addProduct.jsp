...
<html>
  ...
  <tiles:insertDefinition name="baseLayout">
    <tiles:putAttribute name="title"> addProduct.title </tiles:putAttribute>
    <tiles:putAttribute name="heading"> addProduct.heading </tiles:putAttribute>
    <tiles:putAttribute name="tagline"> addProduct.tagline </tiles:putAttribute>
